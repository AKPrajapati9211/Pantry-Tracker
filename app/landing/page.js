    ...
    <ThemeProvider theme={theme}>
      ...
      <Container maxWidth="md">
        ...
        <Box
          ...
          mb={2}
        >
          <a href="https://AKPrajapati9211.github.io/" target="_blank" rel="noopener noreferrer" style={{ color: theme.palette.secondary.main, textDecoration: 'none', margin: '0 1rem' }}>
            <Public />
          </a>
          <a href="https://github.com/AKPrajapati9211" target="_blank" rel="noopener noreferrer" style={{ color: theme.palette.secondary.main, textDecoration: 'none', margin: '0 1rem' }}>
            <GitHub />
          </a>
          <a href="https://www.linkedin.com/in/ankit-kumar-prajapati-8b0443237/" target="_blank" rel="noopener noreferrer" style={{ color: theme.palette.secondary.main, textDecoration: 'none', margin: '0 1rem' }}>
            <LinkedIn />
          </a>
        </Box>
      </Container>
